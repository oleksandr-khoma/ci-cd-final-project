...
echo "=========================================="
echo "This uses combined CI+Build task (clone+lint+test+build)"
echo "all in ONE pod to work without PVC quota"
echo "=========================================="
echo ""
...
echo "=========================================="
echo ""
echo "This pipeline uses 2 tasks:"
echo "  1. ci-and-build (clone → lint → test → build in ONE pod)"
echo "  2. deploy (openshift-client)"
echo ""
echo "The CI+Build task combines all steps into ONE pod,"
echo "so files (including Dockerfile) persist without needing PVC!"
echo ""
...
echo "  oc logs -f \${LATEST}-ci-and-build-pod"
echo ""
